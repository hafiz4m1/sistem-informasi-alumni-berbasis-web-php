    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Menampilkan Data Alumni Dengan Status <strong>Alumni</strong></p>
            </div>
        </section>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">NIK: <?php echo $row['nik']; ?></p>
                                    <p class="card-text">Jenis Kelamin: <?php echo $row['jenis_kelamin']; ?></p>
                                    <p class="card-text">Tempat Lahir: <?php echo $row['tempat_lahir']; ?></p>
                                    <p class="card-text">Tanggal Lahir: <?php echo $row['tanggal_lahir']; ?></p>
                                    <p class="card-text">Agama: <?php echo $row['agama']; ?></p>
                                    <p class="card-text">Pendidikan: <?php echo $row['pendidikan_terakhir']; ?></p>
                                    <p class="card-text">Alamat: <?php echo $row['alamat']; ?></p>
                                    <p class="card-text">No Telepon: <?php echo $row['no_telepon']; ?></p>
                                    <p class="card-text">Angkatan Alumni: <?php echo $row['angkatan_alumni']; ?></p>
                                    <p class="card-text">Nama Pelatihan: <?php echo $row['nama_pelatihan']; ?></p>
                                    <p class="card-text">Tahun Alumni: <?php echo $row['tahun_alumni']; ?></p>

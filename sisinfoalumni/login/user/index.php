    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Menampilkan Data Alumni Dengan Status <strong>Pelatih</strong></p>
            </div>
        </section>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 box-shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nama Perusahaan: <?php echo $row['pendidikan_terakhir']; ?></p>
                                    <p class="card-text">Jenis Pelatihan: <?php echo $row['jenis_pelatihan']; ?></p>
                                    <p class="card-text">Tahun Kerja: <?php echo $row['tahun_kerja']; ?></p>

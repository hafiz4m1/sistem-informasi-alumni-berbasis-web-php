    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Menampilkan Data Usaha Dengan Status <strong>Usaha</strong></p>
            </div>
        </section>
                                ...
                                if ($row['gambar'] != "") { ?>
                                    <center>
                                        <img class="card-img-top" style="width:200px;height:220px;"
                                            src="../admin/crudusaha/gambar/<?php echo $row['gambar']; ?>" alt="Card image cap">
                                    </center>
                                <?php } ?>
                                <div class="card-body">
                                    <p class="card-text">Nama: <?php echo $row['nama']; ?></p>
                                    <p class="card-text">Jenis Kelamin: <?php echo $row['jenis_kelamin']; ?></p>
                                    <p class="card-text">Jenis Usaha: <?php echo $row['jenis_usaha']; ?></p>
                                    <p class="card-text">Alamat Usaha: <?php echo $row['alamat_usaha']; ?></p>
                                    <p class="card-text">Tahun Mulai Usaha: <?php echo $row['tahun_usaha']; ?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <?php
                                            if ($row['gambar'] != "") { ?>
                                                <a type="button"
                                                    href="../admin/crudusaha/lihat.php?id=<?php echo $row['id']; ?>"
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="profile/createdata/usaha/reqedit.php?id=<?php echo $row['id']; ?>">Suggest
                                                    Edit</a>
                                                <a class="dropdown-item" href="deleteitems.php?from=usaha.php">Request
                                                    Delete Data</a>
                                            </div>
                                        </div>
                                    </div>

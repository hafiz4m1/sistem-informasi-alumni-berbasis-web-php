    ...
    if (empty($access)) {
        if ($gambar != "") {
            ...
            if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
                ...
                $query = "INSERT INTO requestedit (id_request,jenis_table,nama,nik,jenis_kelamin,tempat_lahir,tanggal_lahir,agama,pendidikan_terakhir,alamat,no_telepon,angkatan_alumni,nama_pelatihan,tahun_alumni,request_by,gambar) values ('$id_request','kerjakuliah','$nama_kerkul','$nik','$jenis_kelamin','$tempat_lahir','$tanggal_lahir','$agama','$pendidikan_terakhir','$alamat','$no_telepon','$angkatan_alumni','$nama_pelatihan','$tahun_alumni','$nameuser','$nama_gambar_baru')";

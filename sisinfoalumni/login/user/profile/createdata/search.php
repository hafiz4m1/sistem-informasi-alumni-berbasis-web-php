                ...
                <form class="form-inline" method="GET">
                    <div class="selectdiv" style="width:165px">
                        <select name="kategori">
                            ...
                            <option value="kerja">Pelatih</option>
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $log['pendidikan_terakhir']; ?></td>
                        <td><?= $log['jenis_pelatihan']; ?></td>
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $log3['tempat_lahir']; ?></td>
                        <td><?= $log3['pendidikan_terakhir']; ?></td>
                        <td><?= $log3['tahun_alumni']; ?></td>
                        <td><?= $log3['angkatan_alumni']; ?></td>
                        <td><?= $log3['nama_pelatihan']; ?></td>
                        <?php if ($log3['gambar'] != "") { ?>

...
if($gambar != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $query = "INSERT INTO request (jenis_table,nama,jenis_kelamin,nama_perusahaan,jenis_pelatihan,tahun_kerja,requested_by,gambar) values ('kerja','$nama_kerja','$jenis_kelamin','$nama_perusahaan',

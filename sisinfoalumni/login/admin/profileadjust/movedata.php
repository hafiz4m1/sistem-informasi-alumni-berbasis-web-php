...
while ($log = mysqli_fetch_array($data)) {
    ...
    if ($tabel == "kerja") {
        $query = "INSERT INTO kerja(nama,jenis_kelamin,pendidikan_terakhir,jenis_pelatihan,tahun_kerja,gambar) values ('$nama','$jenis_kelamin','$pendidikan_terakhir',
                                '$jenis_pelatihan','$tahun','$gambar')";
    ...
    if ($tabel == "kerjakuliah") {
        $query = "INSERT INTO kerjakuliah(nama,jenis_kelamin,pendidikan_terakhir,jenis_pelatihan,tahun_kerja,uni_ver,jurusan,gambar) values ('$nama','$jenis_kelamin','$pendidikan_terakhir',
                                '$jenis_pelatihan','$tahun','$namauni','$jurusan','$gambar')";
        $result = mysqli_query($koneksi, $query);
        if (!$result) {
            die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
                " - " . mysqli_error($koneksi));

...
while ($log = mysqli_fetch_array($data)) {
    ...
    $pendidikan_terakhir = $log['pendidikan_terakhir'];
    $jenis_pelatihan = $log['jenis_pelatihan'];
    ...
    if ($tabel == "kerja") {
        if ($gambar != "") {
            ...
            $query = "UPDATE kerja SET nama = '$nama', jenis_kelamin = '$jenis_kelamin', pendidikan_terakhir = '$pendidikan_terakhir', jenis_pelatihan = '$jenis_pelatihan', tahun_kerja = '$tahun', gambar = '$gambar'";
            ...
            $query = "UPDATE kerja SET nama = '$nama', jenis_kelamin = '$jenis_kelamin', pendidikan_terakhir = '$pendidikan_terakhir', jenis_pelatihan = '$jenis_pelatihan', tahun_kerja = '$tahun'";
            $query .= "WHERE id ='$id_req'";
            $result = mysqli_query($koneksi, $query);
            if (!$result) {
                die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
    ...
    if ($tabel == "kerjakuliah") {
        if ($gambar != "") {
            ...
            $query = "UPDATE kerjakuliah SET nama = '$nama', jenis_kelamin = '$jenis_kelamin',pendidikan_terakhir = '$pendidikan_terakhir', jenis_pelatihan = '$jenis_pelatihan', tahun_kerja = '$tahun', uni_ver = '$namauni', jurusan = '$jurusan', gambar = '$gambar'";
            $query .= "WHERE id = '$id_req'";
            $result = mysqli_query($koneksi, $query);
            if (!$result) {
                die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
            ...
            $query = "UPDATE kerjakuliah SET nama = '$nama', jenis_kelamin = '$jenis_kelamin',pendidikan_terakhir = '$pendidikan_terakhir', jenis_pelatihan = '$jenis_pelatihan', tahun_kerja = '$tahun', uni_ver = '$namauni', jurusan = '$jurusan'";
            $query .= "WHERE id = '$id_req'";
            $result = mysqli_query($koneksi, $query);
            if (!$result) {
                die("Query gagal dijalankan: " . mysqli_errno($koneksi) .

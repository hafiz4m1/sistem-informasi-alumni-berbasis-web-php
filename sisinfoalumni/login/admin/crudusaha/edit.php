...
<body>
	...
	<div class="container-contact100">
            ...
            <input name="id" value="<?php echo $data['id']; ?>"  hidden />
				...
				<div class="wrap-input100 validate-input" date-validate="Masukkan jenis usahamu!!">
                    <span class="label-input100">Jenis Usaha</span>
                    <input class="input100" type="text" name="jenisusaha" placeholder="Masukkan jenis usahamu!!" value="<?php echo $data['jenis_usaha'];?>" required>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" date-validate="Masukkan Alamat Usaha!">
                    <span class="label-input100">Alamat Usaha</span>
                    <input class="input100" name="alamatusaha" placeholder="Masukkan alamat usahamu!!" value="<?php echo $data['alamat_usaha'];?>" required/>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" date-validate="Masukkan Tahun Usahamu!">
                    <span class="label-input100">Tahun Usaha</span>
                    <input class="input100" type="number" min="1900" max="2099" step="1" name="tahunusaha" value="<?php echo $data['tahun_usaha'];?>" required/>
					<span class="focus-input100"></span>
				</div>

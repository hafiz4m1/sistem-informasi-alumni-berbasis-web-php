    ...
    <div class="content transition">
        <div class="container-fluid dashboard">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Table Kuliah</h5>
                        <?php if (isset($_GET['pesan'])) { ?>
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <?php echo htmlspecialchars($_GET['pesan']); ?>
                                <button type="button" class="close" onclick="window.location.href='kuliah.php';" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                        <?php } ?>
                        <div class="mb-3">
                            <a href="crudkul/tambah.php" class="btn btn-primary btn-icon"><i class="fas fa-plus"></i>
                                Tambah Data</a>
                            <a href="crudkul/print.php" class="btn btn-info btn-icon" target="_blank"><i class="fas fa-print"></i> Print</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    while ($log = mysqli_fetch_assoc($querydata)) { ?>
                                        <tr>
                                            ...
                                            <?php if ($log['gambar'] != "") { ?>
                                                <td><a href="crudkul/lihat.php?id=<?php echo $log['id']; ?>"><img src="crudkul/gambar/<?php echo $log['gambar']; ?>" style="width:50px;"></a></td>
                                            <?php } ?>
                                            <?php if ($log['gambar'] == "") { ?>
                                                <td>Tidak ada gambar</td>
                                            <?php } ?>
                                            <td class="text-center"><a href="crudkul/edit.php?id=<?php echo $log['id']; ?>" class="btn btn-warning btn-icon"><i class="fas fa-edit"></i> Edit</td>
                                            <td class="text-center"><a href="crudkul/hapus.php?id=<?php echo $log['id']; ?>" class="btn btn-danger btn-icon" onclick="return confirm('Yakin ingin hapus data?')"><i class="fas fa-trash-alt"></i> Hapus</td>
                                        </tr>
                                    <?php
                                    }
                                    ?>

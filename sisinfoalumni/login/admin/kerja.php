...
<body>
    ...
    <button type="button" class="btn transition" id="sidebar-toggle" style="color: red;"
        onclick="window.location.href='http://localhost/sistem-informasi-alumni-berbasis-web-php/sisinfoalumni/login/logout.php'">
  Log Out
</button>
                                ...
                                <tbody>
                                    ...
                                    while ($log = mysqli_fetch_assoc($querydata)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $log['jenis_pelatihan']; ?></td>

...
<head>
	<title>Sistem Informasi Alumni | Basic</title>
	<meta charset="utf-8" />
...
<body>
	...
	<header id="header" class="alt">
		<div class="logo"><a href="index.php">SisInfoAlumni <span>MHS | Basic</span></a></div>
		<span>You are viewing the basic. <a href="index.php">See Original.</a></span>
		<a href="#menu">Menu</a>
	</header>
	...
	<section class="banner full">
		<article>
			...
			<div class="inner">
				<div>
					<header>
						<p>M. Hafiz Nuril Ikhsan Present</p>
		...
		<div class="inner">
			<div class="grid-style">
				...
				<div>
					<div class="box">
						<div class="image fit">
							<img src="images/mhs.jpg" style="height:450px;" alt="" />
						</div>
						<div class="content">
					...
					<div class="box">
						...
						<div class="content">
							...
							<p>Sistem Informasi Alumni merupakan Aplikasi Web yang berfungsi sebagai tempat para alumni untuk mencari
								informasi sesama Alumni, menambahkan data diri, dan lain sebagainya. Sistem ini dirancang oleh M. Hafiz Nuril Ikhsan.</p>
							<footer class="align-center">
	...
	<section id="two" class="wrapper style3">
		<div class="inner">
			<header class="align-center">
				...
				<a href="login/daftar/register.php" class="button">Sign UP!</a>
			</header>
		</div>
	</section>
	...
	<footer id="footer">
		...
		<div class="copyright">
			&copy; 2020-Infinity(?). All rights reserved. Optimized by M. Hafiz Nuril Ikhsan. | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
